...
.. 2. Native Compil
.. 3. Quieter Startup
2. STARTUP PROGRAMMES
.. 1. Setting up package repos
.. 2. Disabling uneeded
.. 3. All icons
3. GUI TWEAKS
.. 1. Settings
...
.. 1. Setting Font
.. 2. Zoom in and out
8. RAINBOW DELIMETERS
9. KEYS
.. 1. General Keys
.. 2. Keybindings
.. 3. Tabs
10. SPLITS AND WINDOW CONTROLS
11. BUFFERS
12. BOOKMARKS
13. EVALUATE ELISP EXPRESSIONS
14. ORG MODE
.. 1. Defining some things
.. 2. Enabling Org Bullets
.. 3. Org Todo Keywords
.. 4. Org Settings
.. 5. Org Present
.. 6. Org Tree
.. 7. Source Code Block Expansion
.. 8. Source Code Block Syntax Highlighting
...
════════════════════
  ...
  The order in which the various Emacs modules load is very important.
  So the very first code block is going to contain essential modules
  that many other modules will depend on later in this config.


2.1 Setting up package repos
────────────────────────────
...
14.7 Source Code Block Expansion
────────────────────────────────
...
14.8 Source Code Block Syntax Highlighting
──────────────────────────────────────────
...
════════
  ...
  for image previews (peep-dired).  I’ve chosen the format of ‘SPC d’
  plus ‘key’.
...
═════════════════════════
  ...
  Ivy, counsel and swiper are a generic completion mechanism for Emacs.
