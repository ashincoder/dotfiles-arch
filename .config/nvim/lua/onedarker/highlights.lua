local highlights = {
   ...
   DiffAdd = { fg = C.green, bg = C.sign_add },
   DiffChange = { fg = C.yellow, bg = C.sign_change, style = "underline" },
   DiffDelete = { fg = C.light_red, bg = C.sign_delete },
   ...
   Debug = { fg = C.red },
   Delimiter = { fg = C.fg },
   SpecialComment = { fg = C.gray, style = "bold" },
